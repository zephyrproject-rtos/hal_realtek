...
/** @defgroup RTC_TR
  ...
  * @{
  */
#define RTC_MASK_DAY   ((u32)0x000001FF << 23)           /*!< R/W 0x0  DAY in binary format*/
#define RTC_DAY(x)     (((u32)((x) & 0x000001FF) << 23))
#define RTC_GET_DAY(x) ((u32)(((x >> 23) & 0x000001FF)))
#define RTC_BIT_PM     ((u32)0x00000001 << 22)           /*!< R/W 0x0  PM:AM/PM notation *0: AM or 24-hour foramt *1: PM*/
#define RTC_PM(x)      ((u32)(((x) & 0x00000001) << 22))
#define RTC_MASK_HT    ((u32)0x00000003 << 20)           /*!< R/W 0x0  Hour tens in BCD format*/
#define RTC_HT(x)      (((u32)((x) & 0x00000003) << 20))
#define RTC_GET_HT(x)  ((u32)(((x >> 20) & 0x00000003)))
#define RTC_MASK_HU    ((u32)0x0000000F << 16)           /*!< R/W 0x0  Hour units in BCD format*/
#define RTC_HU(x)      (((u32)((x) & 0x0000000F) << 16))
#define RTC_GET_HU(x)  ((u32)(((x >> 16) & 0x0000000F)))
#define RTC_MASK_MNT   ((u32)0x00000007 << 12)           /*!< R/W 0x0  Minute tens in BCD format*/
#define RTC_MNT(x)     (((u32)((x) & 0x00000007) << 12))
#define RTC_GET_MNT(x) ((u32)(((x >> 12) & 0x00000007)))
#define RTC_MASK_MNU   ((u32)0x0000000F << 8)            /*!< R/W 0x0  Minute units in BCD format*/
#define RTC_MNU(x)     (((u32)((x) & 0x0000000F) << 8))
#define RTC_GET_MNU(x) ((u32)(((x >> 8) & 0x0000000F)))
#define RTC_MASK_ST    ((u32)0x00000007 << 4)            /*!< R/W 0x0  Second tens in BCD format*/
#define RTC_ST(x)      (((u32)((x) & 0x00000007) << 4))
#define RTC_GET_ST(x)  ((u32)(((x >> 4) & 0x00000007)))
#define RTC_MASK_SU    ((u32)0x0000000F << 0)            /*!< R/W 0x0  Second units in BCD format*/
...
#define RTC_BIT_CLKDIV2_EN   ((u32)0x00000001 << 17)           /*!< R/W 0x1  rtc_clk/rtc_bclk use divided clock enable *0: unuse div2 clk  *1: use div2 clk*/
#define RTC_CLKDIV2_EN(x)    ((u32)(((x) & 0x00000001) << 17))
#define RTC_BIT_DOVTHIE      ((u32)0x00000001 << 16)           /*!< R/W 0x0  Day over threshold interrupt enable *0: Day over threshold interrupt disabled *1: Day over threshold interrupt enabled*/
#define RTC_DOVTHIE(x)       ((u32)(((x) & 0x00000001) << 16))
#define RTC_BIT_WUTIE        ((u32)0x00000001 << 14)           /*!< R/W 0x0  Wakeup timer interrupt enable *0: Wakeup timer interrupt disabled *1: Wakeup timer interrupt enabled*/
#define RTC_WUTIE(x)         ((u32)(((x) & 0x00000001) << 14))
#define RTC_BIT_ALMIE        ((u32)0x00000001 << 12)           /*!< R/W 0x0  Alarm interrupt enable *0: Alarm interrupt disabled *1: Alarm interrupt enabled*/
#define RTC_ALMIE(x)         ((u32)(((x) & 0x00000001) << 12))
#define RTC_BIT_WUTE         ((u32)0x00000001 << 10)           /*!< R/W 0x0  Wakeup timer enable *0: Wakeup timer disabled *1: Wakeup timer enabled*/
#define RTC_WUTE(x)          ((u32)(((x) & 0x00000001) << 10))
#define RTC_BIT_ALME         ((u32)0x00000001 << 8)            /*!< R/W 0x0  Alarm enable *0: Alarm disabled *1: Alarm enabled*/
#define RTC_ALME(x)          ((u32)(((x) & 0x00000001) << 8))
#define RTC_BIT_FMT          ((u32)0x00000001 << 7)            /*!< R/W 0x0  Hour format *0: 24 hour/day format *1: AM/PM hour format*/
#define RTC_FMT(x)           ((u32)(((x) & 0x00000001) << 7))
#define RTC_MASK_OSEL        ((u32)0x00000003 << 5)            /*!< R/W 0x0  Output selection.There bits are used to select the flag to be routed to RTC_OUT output. *00: Output disabled *01: Alarm output enabled *10: Clock output is clk_spre (default:1Hz) *11: Clock output is clk_apre (default:256Hz)*/
#define RTC_OSEL(x)          (((u32)((x) & 0x00000003) << 5))
#define RTC_GET_OSEL(x)      ((u32)(((x >> 5) & 0x00000003)))
#define RTC_BIT_BYPSHAD      ((u32)0x00000001 << 3)            /*!< R/W 0x0  Bypass the shadow registers. *0: Calendar values (when reading from RTC_TR) are taken from the shadow register, which are updated once every two RTCCLK cycles. *1: Calendar values (when reading from RTC_TR) are taken directly from the calendar counters.*/
#define RTC_BYPSHAD(x)       ((u32)(((x) & 0x00000001) << 3))
#define RTC_BIT_BKP          ((u32)0x00000001 << 2)            /*!< R/W 0x0  Backup This bit can be written by the user to memorize whether the daylight saving time change has been performed or not.*/
#define RTC_BKP(x)           ((u32)(((x) & 0x00000001) << 2))
#define RTC_BIT_SUB1H        ((u32)0x00000001 << 1)            /*!< W 0x0  Subtract one hour(winter time change),when this bit is set outside initialization mode,1 hour is subtracted to the calendar time if the current hour is not 0,this bit is always read as 0. *0:No effect *1:subtract one hour to the current time*/
#define RTC_SUB1H(x)         ((u32)(((x) & 0x00000001) << 1))
#define RTC_BIT_ADD1H        ((u32)0x00000001 << 0)            /*!< W 0x0  Add one hour(summer time change),when this bit is set outside initialization mode,1 hour is add to the calendar time,this bit is always read as 0. *0:No effect *1:add one hour to the current time*/
...
/** @defgroup RTC_ISR
  ...
  * @{
  */
#define RTC_BIT_RECALPF ((u32)0x00000001 << 16)           /*!< R 0x0  Recalibration pending flag The RECALPF status flag is automatically set to '1' when software writes to the RTC_CALIBR register, indicating that the RTCCALIBR register is blocked. When the new calibration settings are taken into account, this bit returns to '0'. Refer to Re-calibration on-the-fly.*/
#define RTC_RECALPF(x)  ((u32)(((x) & 0x00000001) << 16))
#define RTC_BIT_DOVTHF  ((u32)0x00000001 << 15)           /*!< RW1C 0x0  Day over threshold flag This flag is set by hardware when the Day in RTC_TR over the DAY_THRES set in RTC_CR register.*/
#define RTC_DOVTHF(x)   ((u32)(((x) & 0x00000001) << 15))
#define RTC_BIT_WUTF    ((u32)0x00000001 << 10)           /*!< RW1C 0x0  Wakeup timer flag This flag is set by hardware when the wakeup auto-reload counter reaches to. This flag must be cleared by software at least 2 RTCCLK periods before WUTF is set to '1' again.*/
#define RTC_WUTF(x)     ((u32)(((x) & 0x00000001) << 10))
#define RTC_BIT_ALMF    ((u32)0x00000001 << 8)            /*!< RW1C 0x0  Alarm flag This flag is set by hardware when the time register (RTC_TR) matches the Alarm registers (RTC_ALMR1L and RTC_ALMR1H).*/
#define RTC_ALMF(x)     ((u32)(((x) & 0x00000001) << 8))
#define RTC_BIT_INIT    ((u32)0x00000001 << 7)            /*!< R/W 0x0  Initialization mode *0: Free running mode. *1: Initialization mode used to program time and date register (RTC_TR), and prescaler register (RTC_PRER). Counters are stoped and start counting from the new value when INIT is set.*/
#define RTC_INIT(x)     ((u32)(((x) & 0x00000001) << 7))
#define RTC_BIT_INITF   ((u32)0x00000001 << 6)            /*!< R 0x0  Initialization flag. When this bit is set to '1', the RTC is in initialization state, and the time, date, and prescaler registers can be updated. *0: Calendar registers update is not allowed. *1: Calendar registers update is allowed.*/
#define RTC_INITF(x)    ((u32)(((x) & 0x00000001) << 6))
#define RTC_BIT_RSF     ((u32)0x00000001 << 5)            /*!< RW1C 0x0  Registers synchronization flag. This bit is set by hardware each time the calendar registers are copied into the shadow registers (RTC_TR). This bit is cleared by hardware in initialization mode or when in bypass shadow register mode (BYPSHAD=1). This bit can also be cleared by software. It is cleared either by software or by hardware in initialization mode. *0: Calendar shadow registers are not yet synchronized. *1: Calendar shadow registers are synchronized.*/
#define RTC_RSF(x)      ((u32)(((x) & 0x00000001) << 5))
#define RTC_BIT_INITS   ((u32)0x00000001 << 4)            /*!< R 0x0  This bit is set by hardware when the calendar day field is different from 0 (RTC domain reset state). *0: Calendar has not been initialized. *1: Calendar has been initialized.*/
#define RTC_INITS(x)    ((u32)(((x) & 0x00000001) << 4))
#define RTC_BIT_WUTWF   ((u32)0x00000001 << 2)            /*!< R 0x0  Wakeup timer write flag This flag is set by hardware when WUT value can be changed, after the WUTE bit has been set to '0' in RTC_CR. *0: Wakeup timer configuration update not allowd except in initialization mode *1: Wakeup timer configuration update allowed*/
#define RTC_WUTWF(x)    ((u32)(((x) & 0x00000001) << 2))
#define RTC_BIT_WUTRSF  ((u32)0x00000001 << 1)            /*!< RW1C 0x0  This bit is set by hardware each time the WUTE bit is copied into the shadow register. This bit is cleared by hardware in initialization mode. This bit can also be cleared by software. It is cleared either by software or by hardware in initialization mode. *0: WUTE is not yet synchronized. *1: WUTE is synchronized.*/
#define RTC_WUTRSF(x)   ((u32)(((x) & 0x00000001) << 1))
#define RTC_BIT_ALMWF   ((u32)0x00000001 << 0)            /*!< R 0x0  Alarm write flag This bit is set by hardware when Alarm values can be changed, after the ALME bit has been set to '0' in RTC_CR. It is cleared by hardware when ALME bit has been set to '1' in RTC_CR. *0: Alarm update not allowed *1: Alarm update allowed*/
...
/** @defgroup RTC_CALIBR
  ...
  * @{
  */
#define RTC_MASK_CALP   ((u32)0x00000007 << 16)           /*!< R/W 0x0  Calibration period*/
#define RTC_CALP(x)     (((u32)((x) & 0x00000007) << 16))
#define RTC_GET_CALP(x) ((u32)(((x >> 16) & 0x00000007)))
#define RTC_BIT_DCE     ((u32)0x00000001 << 15)           /*!< R/W 0x0  Digital calibration enable *0: Digital calibration disabled *1: Digital calibration enabled*/
#define RTC_DCE(x)      ((u32)(((x) & 0x00000001) << 15))
#define RTC_BIT_DCS     ((u32)0x00000001 << 14)           /*!< R/W 0x0  Digital calibration signal *0: Positive calibration, time update frequency is increased. *1: Negative calibration, time update frequency is decreased.*/
#define RTC_DCS(x)      ((u32)(((x) & 0x00000001) << 14))
#define RTC_MASK_DC     ((u32)0x0000007F << 0)            /*!< R/W 0x0  Digital calibration*/
...
/** @defgroup RTC_ALMR1L
  ...
  * @{
  */
#define RTC_BIT_MSK2       ((u32)0x00000001 << 23)           /*!< R/W 0x0  Alarm hour mask *0: Alarm set if the hours match *1: Hours don't care in Alarm comparison*/
#define RTC_MSK2(x)        ((u32)(((x) & 0x00000001) << 23))
#define RTC_BIT_ALR_PM     ((u32)0x00000001 << 22)           /*!< R/W 0x0  AM/PM notation. *0: AM or 24-hour format *1: PM*/
#define RTC_ALR_PM(x)      ((u32)(((x) & 0x00000001) << 22))
#define RTC_MASK_ALR_HT    ((u32)0x00000003 << 20)           /*!< R/W 0x0  Hour tens in BCD format*/
#define RTC_ALR_HT(x)      (((u32)((x) & 0x00000003) << 20))
#define RTC_GET_ALR_HT(x)  ((u32)(((x >> 20) & 0x00000003)))
#define RTC_MASK_ALR_HU    ((u32)0x0000000F << 16)           /*!< R/W 0x0  Hour units in BCD format*/
#define RTC_ALR_HU(x)      (((u32)((x) & 0x0000000F) << 16))
#define RTC_GET_ALR_HU(x)  ((u32)(((x >> 16) & 0x0000000F)))
#define RTC_BIT_MSK1       ((u32)0x00000001 << 15)           /*!< R/W 0x0  Alarm minutes mask. *0: Alarm set if the minutes match *1: Minutes don't care in Alarm comprison*/
#define RTC_MSK1(x)        ((u32)(((x) & 0x00000001) << 15))
#define RTC_MASK_ALR_MNT   ((u32)0x00000007 << 12)           /*!< R/W 0x0  Minute tens in BCD format*/
#define RTC_ALR_MNT(x)     (((u32)((x) & 0x00000007) << 12))
#define RTC_GET_ALR_MNT(x) ((u32)(((x >> 12) & 0x00000007)))
#define RTC_MASK_ALR_MNU   ((u32)0x0000000F << 8)            /*!< R/W 0x0  Minute units in BCD format*/
#define RTC_ALR_MNU(x)     (((u32)((x) & 0x0000000F) << 8))
#define RTC_GET_ALR_MNU(x) ((u32)(((x >> 8) & 0x0000000F)))
#define RTC_BIT_MSK0       ((u32)0x00000001 << 7)            /*!< R/W 0x0  Alarm seconds mask *0: Alarm set if the seconds match *1: Seconds don't care in Alarm comprison*/
#define RTC_MSK0(x)        ((u32)(((x) & 0x00000001) << 7))
#define RTC_MASK_ALR_ST    ((u32)0x00000007 << 4)            /*!< R/W 0x0  Second tens in BCD format*/
#define RTC_ALR_ST(x)      (((u32)((x) & 0x00000007) << 4))
#define RTC_GET_ALR_ST(x)  ((u32)(((x >> 4) & 0x00000007)))
#define RTC_MASK_ALR_SU    ((u32)0x0000000F << 0)            /*!< R/W 0x0  Second units in BCD format*/
#define RTC_ALR_SU(x)      (((u32)((x) & 0x0000000F) << 0))
#define RTC_GET_ALR_SU(x)  ((u32)(((x >> 0) & 0x0000000F)))
/** @} */

/** @defgroup RTC_ALMR1H
  * @brief - RTC Alarm 1 Reg High
  * @{
  */
#define RTC_BIT_MSK3       ((u32)0x00000001 << 9)           /*!< R/W 0x0  Alarm day mask *0: Alarm set if the days match *1: Days don't care in Alarm comprison*/
#define RTC_MSK3(x)        ((u32)(((x) & 0x00000001) << 9))
#define RTC_MASK_ALR_DAY   ((u32)0x000001FF << 0)           /*!< R/W 0x0  DAY in binary format*/
...
/** @defgroup RTC_WPR
  ...
  * @{
  */
#define RTC_MASK_KEY   ((u32)0x000000FF << 0)           /*!< R/W 0x0  Write protection key This byte is written by software. Refer to RTC register write protection for a description of how to unlock RTC register write protection.*/
...
/** @defgroup RTC_YEAR
  ...
  * @{
  */
#define RTC_BIT_RESTORE ((u32)0x00000001 << 31)           /*!< R/W 0x0  Reset Flag. Indicates whether any reset conditions have occurred (except POR/PDR/BOD), so that the bit is set to '1' before reset, and then the global variable that determines whether the recovery time information is needed depending on whether the bit is '1'.*/
#define RTC_RESTORE(x)  ((u32)(((x) & 0x00000001) << 31))
#define RTC_MASK_YEAR   ((u32)0x000000FF << 0)            /*!< R/W 0x0  Year in binary format*/
...
/** @defgroup RTC_WUTR
  ...
  * @{
  */
#define RTC_MASK_WUT   ((u32)0x0001FFFF << 0)           /*!< R/W 0x0  Wakeup auto-reload value bits When the wakeup timer is enabled (WUTE is set to '1'), the WUTF flag is set every (WUT[16:0]+1) cycles. The first assertion of WUTF occurs between WUT and (WUT+1) cycles after WUTE is set.*/
...
typedef struct {
	...
	__IO uint32_t RTC_DUMMY ;  /*!< RTC DUMMY REGISTER,  Address offset:0x028 */
} RTC_TypeDef;
