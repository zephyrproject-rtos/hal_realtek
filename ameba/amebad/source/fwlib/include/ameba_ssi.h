...
#define SPI_BIT_RXOIS		BIT_ISR_RXOIS
#define SPI_BIT_TXUIS		BIT_ISR_TXUIS
...
#define SPI_BIT_RXUIM		BIT_IMR_RXUIM
#define SPI_BIT_TXOIM		BIT_IMR_TXOIM
#define SPI_BIT_TXEIM		BIT_IMR_TXEIM

/* SPI_DMACR */
#define SPI_BIT_TDMAE		BIT_SHIFT_DMACR_TDMAE
#define SPI_BIT_RDMAE		BIT_SHIFT_DMACR_RDMAE
/* redirect end */
