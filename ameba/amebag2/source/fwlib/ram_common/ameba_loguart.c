...
static LOG_UART_PORT LOG_UART_IDX_FLAG[] = {
	{LOGUART_PATH_INDEX_1, LOGUART_BIT_TP1F_NOT_FULL, LOGUART_BIT_TP1F_EMPTY, 781875, UART_LOG_IRQ},	/* AP IDX NOT_FULL EMPTY TX_TIMEOUT IRQ*/
	{LOGUART_PATH_INDEX_2, LOGUART_BIT_TP2F_NOT_FULL, LOGUART_BIT_TP2F_EMPTY, 52125, UART_LOG_IRQ},		/* NP IDX NOT_FULL EMPTY TX_TIMEOUT IRQ*/
};
