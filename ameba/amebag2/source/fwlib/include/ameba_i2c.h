...
/** @defgroup IC_CLR_GEN_CALL
  * @brief Clear GEN_ALL Interrupt Register
  * @{
  */
...
/** @defgroup IC_STATUS
  ...
  * @{
  */
#define I2C_MASK_BUS_MONITOR_STATUS   ((u32)0x00000003 << 8)           /*!< R 0x0  BUS monitor status:  * 2'b00: IDLE * 2'b01: ADDR * 2'b10: DATA * 2'b11:STRTCH*/
#define I2C_BUS_MONITOR_STATUS(x)     (((u32)((x) & 0x00000003) << 8))
#define I2C_GET_BUS_MONITOR_STATUS(x) ((u32)(((x >> 8) & 0x00000003)))
...
/** @defgroup IC_DMA_CR
  ...
  * @{
  */
#define I2C_BIT_TDMAE ((u32)0x00000001 << 1) /*!< R/W 0x0  Transmit DMA Enable. This bit enables/disables the transmit FIFO DMA channel. * 0: Transmit DMA disabled * 1: Transmit DMA enabled*/
#define I2C_BIT_RDMAE ((u32)0x00000001 << 0) /*!< R/W 0x0  Receive DMA Enable. This bit enables/disables the receive FIFO DMA channel. * 0: Receive DMA disabled * 1: Receive DMA enabled*/
/** @} */

/** @defgroup IC_DMA_TDLR
  * @brief DMA Transmit Data Level Register
  * @{
  */
#define I2C_MASK_DMATDL   ((u32)0x0000000F << 0)           /*!< R/W 0x0  Transmit Data Level. This bit field controls the level at which a DMA request is made by the transmit logic. It is equal to the watermark level; that is, the dma_tx_req signal is generated when the number of valid data entries in the transmit FIFO is equal to or below this field value, and TDMAE=1.*/
#define I2C_DMATDL(x)     (((u32)((x) & 0x0000000F) << 0))
#define I2C_GET_DMATDL(x) ((u32)(((x >> 0) & 0x0000000F)))
/** @} */

/** @defgroup IC_DMA_RDLR
  * @brief I2C Reveive Data Level Register
  * @{
  */
#define I2C_MASK_DMARDL   ((u32)0x0000000F << 0)           /*!< R/W 0x0  Receive Data Level. This bit field controls the level at which a DMA request is made by the receive logic. The watermark level=DMARDL+1; that is, the dma_tx_req signal is generated when the number of valid data entries in the receive FIFO is equal to or more than this field value+1, and RDMAE=1. For instance, when DMARDL is 0, the dma_rx_req is asserted when 1 or more data entries are present in the receive FIFO.*/
#define I2C_DMARDL(x)     (((u32)((x) & 0x0000000F) << 0))
#define I2C_GET_DMARDL(x) ((u32)(((x >> 0) & 0x0000000F)))
/** @} */
...
/** @defgroup IC_ENABLE_STATUS
  ...
  * @{
  */
#define I2C_MASK_BUSY_IN_MODE          ((u32)0x00000003 << 3)           /*!< R 0x0  * 00: I2C is disable while busy in legacy mode * 01: I2C is disable while busy in DMA mode * 10: I2C is disable while busy in Descriptor mode*/
#define I2C_BUSY_IN_MODE(x)            (((u32)((x) & 0x00000003) << 3))
#define I2C_GET_BUSY_IN_MODE(x)        ((u32)(((x >> 3) & 0x00000003)))
...
/** @defgroup IC_DMA_DATA_LEN
  * @brief I2C DMA Mode Transfer Data Length Register
  * @{
  */
#define I2C_MASK_DMA_DAT_LEN   ((u32)0x0000FFFF << 0)           /*!< R/W 0x0  DMA transfer data length*/
#define I2C_DMA_DAT_LEN(x)     (((u32)((x) & 0x0000FFFF) << 0))
#define I2C_GET_DMA_DAT_LEN(x) ((u32)(((x >> 0) & 0x0000FFFF)))
/** @} */

/** @defgroup IC_DMA_MODE
  * @brief I2C DMA Mode Register
  * @{
  */
#define I2C_MASK_DMA_MODE   ((u32)0x00000003 << 0)           /*!< R/W 0x0  * 0: DWC DMA legacy mode * 1: DMA with control register * 2: DMA with transfer descriptor*/
#define I2C_DMA_MODE(x)     (((u32)((x) & 0x00000003) << 0))
#define I2C_GET_DMA_MODE(x) ((u32)(((x >> 0) & 0x00000003)))
/** @} */
...
/** @defgroup IC_CLR_DMA_DONE
  * @brief Clear DMA DONE Interrupt Register
  * @{
  */
#define I2C_BIT_IC_CLR_RAW_INTR_STAT ((u32)0x00000001 << 0) /*!< R 0x0  Read this register to clear the DMA_DONE interrupt (bit 15) of IC_RAW_INTR_STAT register.*/
/** @} */
...
#define I2C_MASK_IC_DIG_FLTR_DEG   ((u32)0x0000003F << 0)           /*!< R/W 0x0  DIG_FLTR_DEG is to define frequency range of filter. A greater value of DIG_FLTR_DEG results in a slower transfer speed and hardware would be able to filter a lower frequency.*/
#define I2C_IC_DIG_FLTR_DEG(x)     (((u32)((x) & 0x0000003F) << 0))
#define I2C_GET_IC_DIG_FLTR_DEG(x) ((u32)(((x >> 0) & 0x0000003F)))
/** @} */
...
/** @defgroup IC_COMP_VERSION
  ...
  * @{
  */
#define I2C_MASK_IC_COMP_VERSION   ((u32)0xFFFFFFFF << 0)           /*!< R 0x20200702  I2C version number*/
...
typedef struct {
	...
	__I  uint32_t IC_CLR_RX_UNDER      ;  /*!< CLEAR RX_UNDER INTERRUPT REGISTER,  Address offset:0x044 */
	__I  uint32_t IC_CLR_RX_OVER       ;  /*!< CLEAR RX_OVER INTERRUPT REGISTER,  Address offset:0x048 */
	__I  uint32_t IC_CLR_TX_OVER       ;  /*!< CLEAR TX_OVER INTERRUPT REGISTER,  Address offset:0x04C */
	__I  uint32_t IC_CLR_RD_REQ        ;  /*!< CLEAR RD_REQ INTERRUPT REGISTER,  Address offset:0x050 */
	__I  uint32_t IC_CLR_TX_ABRT       ;  /*!< CLEAR TX_ABRT INTERRUPT REGISTER,  Address offset:0x054 */
	__I  uint32_t IC_CLR_RX_DONE       ;  /*!< CLEAR RX_DONE INTERRUPT REGISTER,  Address offset:0x058 */
	__I  uint32_t IC_CLR_ACTIVITY      ;  /*!< CLEAR ACTIVITY INTERRUPT REGISTER,  Address offset:0x05C */
	__I  uint32_t IC_CLR_STOP_DET      ;  /*!< CLEAR STOP_DET INTERRUPT REGISTER,  Address offset:0x060 */
	__I  uint32_t IC_CLR_START_DET     ;  /*!< CLEAR START_DET INTERRUPT REGISTER,  Address offset:0x064 */
	__I  uint32_t IC_CLR_GEN_CALL      ;  /*!< CLEAR GEN_ALL INTERRUPT REGISTER,  Address offset:0x068 */
