...
/** @defgroup TRNG_CTRL
  ...
  * @{
  */
#define TRNG_MASK_SECURITY_CONTROL              ((u32)0x0000000F << 16)           /*!< R/W 0x0  If this field is equal to 0xA, the TRNG becomes a non-secure slave, and all the registers can be accessed by non-secure transaction. If this field is not equal to 0xA, the non-seucre transaction can only access address 0xC~0x30.*/
...
/** @defgroup TRNG_EX_CTRL
  * @brief Extractor Control Regsiter
  * @{
  */
#define TRNG_BIT_FORCE_EXTRACTOR_RATE ((u32)0x00000001 << 31)          /*!< R/W 0x1  1: SW programmed extractor rate 0: HW adjustment*/
#define TRNG_MASK_EXTRACTOR_RATE      ((u32)0x0000000F << 0)           /*!< R/W 0x0  0: bypass*/
#define TRNG_EXTRACTOR_RATE(x)        (((u32)((x) & 0x0000000F) << 0))
#define TRNG_GET_EXTRACTOR_RATE(x)    ((u32)(((x >> 0) & 0x0000000F)))
/** @} */

/** @defgroup TRNG_EX_CFGx
  * @brief Extractor Threshold Config x Register
  * @{
  */
#define TRNG_MASK_EXTRACTOR_CFG_x   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  For fine-tune extractor parameter*/
#define TRNG_EXTRACTOR_CFG_x(x)     (((u32)((x) & 0xFFFFFFFF) << 0))
#define TRNG_GET_EXTRACTOR_CFG_x(x) ((u32)(((x >> 0) & 0xFFFFFFFF)))
/** @} */
...
typedef struct {
	...
	__I  uint32_t TRNG_FIFO_STATUS         ;  /*!< ENCODED STATUS REGISTER,  Address offset:0x00C */
	__I  uint32_t TRNG_DATAx[8]            ;  /*!< DATAx REGISTER,  Address offset:0x010-0x02C */
	__I  uint32_t TRNG_STATUS              ;  /*!< DEATAIL STATUS REGISTER,  Address offset:0x030 */
	__IO uint32_t TRNG_CTRL                ;  /*!< CONTROL REGISTER,  Address offset:0x034 */
	__O  uint32_t TRNG_SW_RST              ;  /*!< SOFTWARE RESET REGISTER,  Address offset:0x038 */
	__IO uint32_t RSVD0[51]                ;  /*!< Reserved,  Address offset:0x03C-0x107 */
	__IO uint32_t TRNG_LFSR_CTRL           ;  /*!< LFSR CONTROL REGISTER,  Address offset:0x108 */
	__IO uint32_t RSVD1                    ;  /*!< Reserved,  Address offset:0x10C-0x10F */
	...
	__IO uint32_t RSVD2[41]                ;  /*!< Reserved,  Address offset:0x11C-0x1BF */
	__IO uint32_t TRNG_EX_CTRL             ;  /*!< EXTRACTOR CONTROL REGSITER Register,  Address offset:0x1C0 */
	__IO uint32_t TRNG_EX_CFGx[2]          ;  /*!< EXTRACTOR THRESHOLD CONFIG x REGISTER,  Address offset:0x1C4-0x1C8 */
	__IO uint32_t RSVD3[10]                ;  /*!< Reserved,  Address offset:0x1CC-0x1F3 */
...
_LONG_CALL_ extern int TRNG_Security_Only(bool NewState);
