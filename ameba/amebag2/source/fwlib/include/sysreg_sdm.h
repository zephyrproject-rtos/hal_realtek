...
/** @defgroup SDM_CTRL1
  ...
  * @{
  */
#define SDM_MASK_OBS_CYC   ((u32)0x0000FFFF << 0)           /*!< R/W 0x0  Set observed 128k cycle, default 1024 128k cycles*/
...
/** @defgroup SDM_CTRL2
  ...
  * @{
  */
#define SDM_MASK_OBS_REF_CYC   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  Set in observed cycles, refer to counters value, default 312500 XTAL cycles*/
...
/** @defgroup SDM_CTRL3
  ...
  * @{
  */
#define SDM_MASK_XTAL_PERIOD   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  Set reference xtal period (ns)*/
