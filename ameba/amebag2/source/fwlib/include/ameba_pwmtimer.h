...
typedef struct {
	...
	__IO uint32_t CCRx[4]     ;  /*!< TIM CAPTURE/COMPARE REGISTER x Register,  Address offset:0x024-0x030 */
	__IO uint32_t PSYNCx[4]   ;  /*!< TIM PHASE SYNCHRONIZATION REGISTER x Register,  Address offset:0x034-0x040 */
	__I  uint32_t PHASECNTx[4];  /*!< TIM PHASE COUNTER REGISTER x Register,  Address offset:0x044-0x050 */
	__IO uint32_t PWM_DUMMY   ;  /*!< TIMER PWM DUMMY REGISTER,  Address offset:0x054 */
} RTIM_TypeDef;
...
#define IS_TIM_INPULSE_TIM(PERIPH)	(((PERIPH) == TIM8) || \
									((PERIPH) == TIM8_S))
...
#define IS_TIM_IT(IT)	((((IT) & (u32)0xFFF0FFE0) == 0x0000) && (((IT) & (u32)0xF001F) != 0x0000))
