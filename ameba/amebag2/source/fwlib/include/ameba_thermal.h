...
#ifndef _RL7005_THERMAL_H_
#define _RL7005_THERMAL_H_
...
/** @defgroup TM_GAIN
  ...
  * @{
  */
#define TM_MASK_A   ((u32)0x1FFFFFFF << 0)           /*!< R/W 0x08284000  This bit defines thermal meter gain. * Bit[28:14]: Integer part * Bit[13:0]: Decimal part*/
...
/** @defgroup TM_OFFSET
  ...
  * @{
  */
#define TM_MASK_B   ((u32)0x003FFFFF << 0)           /*!< R/W 0x00371700  This bit defines thermal meter offset.  * Bit21: Signed bit * Bit[20:11]: Integer part * Bit[10:0]: Decimal part*/
...
/** @defgroup TM_CTRL
  ...
  * @{
  */
#define TM_MASK_PWR           ((u32)0x000000FF << 24)           /*!< R/W 0x69  thm protect password.  tm_pow,tm_powcut,tm_rstb,tm_highcmp_pt_en,tm_high_pt_thr, iso_thm can be programed only when this value is 8'h69.*/
...
#define TM_MASK_BIAS_SEL      ((u32)0x00000003 << 4)            /*!< R/W 0x1  Select ADC bias current * 0: 8uA * 1: 10uA * 2: 12uA * 3: 14uA*/
...
/** @defgroup TM_TH_CTRL
  ...
  * @{
  */
#define TM_BIT_ISO_THM        ((u32)0x00000001 << 30)           /*!< R/W 0x0  1: ISO signals from thermal power domain 0: Release*/
...
#define TM_MASK_HIGH_PT_THR   ((u32)0x000001FF << 20)           /*!< R/W 0x07D  Set over temperature protection threshold for comparison with TEMP_OUT. Only between 0x046 (70centigrade) and 0x08C (140centigrade) are valid. * Bit28: Signed bit * Bit[27:20]: Integer part*/
...
typedef struct {
	__IO uint32_t TM_GAIN      ;  /*!< THERMAL METER GAIN REGISTER,  Address offset:0x000 */
	__IO uint32_t TM_OFFSET    ;  /*!< THERMAL METER OFFSET REGISTER,  Address offset:0x004 */
	__IO uint32_t TM_CTRL      ;  /*!< THERMAL METER CONTROL REGISTER,  Address offset:0x008 */
	__IO uint32_t TM_TH_CTRL   ;  /*!< THERMAL METER THRESHOLD CONTROL REGISTER,  Address offset:0x00C */
	__I  uint32_t TM_RESULT    ;  /*!< THERMAL METER TEMPERATURE RESULT REGISTER,  Address offset:0x010 */
	__I  uint32_t TM_ADC_RESULT;  /*!< THERMAL METER ADC RESULT REGISTER,  Address offset:0x014 */
	__IO uint32_t TM_MAX_CTRL  ;  /*!< THERMAL METER MAX TEMPERATURE CONTROL REGISTER,  Address offset:0x018 */
	__IO uint32_t TM_MIN_CTRL  ;  /*!< THERMAL METER MIN TEMPERATURE CONTROL REGISTER,  Address offset:0x01C */
	__I  uint32_t TM_OUT_PWR_ON;  /*!< THERMAL METER POWER ON TEMPERATURE REGISTER,  Address offset:0x020 */
	__IO uint32_t TM_INTR_CTRL ;  /*!< THERMAL METER INTERRUPT CONTROL REGISTER,  Address offset:0x024 */
	__IO uint32_t TM_INTR_STS  ;  /*!< THERMAL METER INTERRUPT STATUS REGISTER,  Address offset:0x028 */
	__IO uint32_t TM_TIMER     ;  /*!< THERMAL METER TIMER REGISTER,  Address offset:0x02C */
	__IO uint32_t TM_DUMMY     ;  /*!< THERMAL DUMMY REGISTER,  Address offset:0x030 */
} THERMAL_TypeDef;
