...
#ifndef _AMEBA_LOGUART_H_
#define _AMEBA_LOGUART_H_
...
#define LOGUART_BIT_MONITOR_DONE_INT ((u32)0x00000001 << 5)            /*!< R 0x0  This bit is only set when Rx Path Monitor Done interrupt is enabled(EMDI is set) 1: Rx path monitor done*/
...
#define LOGUART_MASK_DBG_SEL       ((u32)0x0000001F << 8)            /*!< R/W 0x0  Debug port selection*/
#define LOGUART_DBG_SEL(x)         (((u32)((x) & 0x0000001F) << 8))
#define LOGUART_GET_DBG_SEL(x)     ((u32)(((x >> 8) & 0x0000001F)))
...
/** @defgroup LOGUART_UART_FCR
  ...
  * @{
  */
#define LOGUART_BIT_LOG_FULL_EN ((u32)0x00000001 << 14)           /*!< R/W 0x1  Function enable: when disable agg, and log byte is 0x0a or this fifo is empty timeout, switch tx fifo*/
#define LOGUART_LOG_FULL_EN(x)  ((u32)(((x) & 0x00000001) << 14))
...
/** @defgroup LOGUART_INTERRUPT_MASK
  * @brief loguart interrupt mask Register
  * @{
  */
#define LOGUART_BIT_INTR_MASK_AP ((u32)0x00000001 << 1)           /*!< R/W 0x1  Mask loguart interrupt to AP 1:unmask  0:mask*/
#define LOGUART_INTR_MASK_AP(x)  ((u32)(((x) & 0x00000001) << 1))
#define LOGUART_BIT_INTR_MASK_NP ((u32)0x00000001 << 0)           /*!< R/W 0x1  Mask loguart interrupt to NP 1:unmask  0:mask*/
#define LOGUART_INTR_MASK_NP(x)  ((u32)(((x) & 0x00000001) << 0))
/** @} */
...
typedef struct {
	...
	__IO uint32_t RSVD0                         ;  /*!< Reserved,  Address offset:0x038-0x03B */
	...
	__IO uint32_t RSVD1[29]                     ;  /*!< Reserved,  Address offset:0x07C-0x0EF */
	__IO uint32_t LOGUART_DUMMY                 ;  /*!< LOGUART DUMMY REGISTER,  Address offset:0x0F0 */
} LOGUART_TypeDef;
...
#define LOGUART_RX_FIFOTRIG_LEVEL_QUARTER		((u32)0x00000001) // 4
#define LOGUART_RX_FIFOTRIG_LEVEL_HALF			((u32)0x00000002) // 8
#define LOGUART_RX_FIFOTRIG_LEVEL_MINUS2		((u32)0x00000003) // 14

#define IS_LOGUART_RXFIFO_LEVEL(LEVEL) (((LEVEL) == LOGUART_RX_FIFOTRIG_LEVEL_1BYTES) || \
																				((LEVEL) == LOGUART_RX_FIFOTRIG_LEVEL_QUARTER) || \
																				((LEVEL) == LOGUART_RX_FIFOTRIG_LEVEL_HALF) || \
																				((LEVEL) == LOGUART_RX_FIFOTRIG_LEVEL_MINUS2))
/**
  * @}
  */
...
/** @defgroup LOGUART_Path_Index
  * @{
  */
#define LOGUART_PATH_INDEX_1		((u8)0x00)
#define LOGUART_PATH_INDEX_2		((u8)0x01)
#define LOGUART_PATH_INDEX_3		((u8)0x02)
#define LOGUART_PATH_INDEX_4		((u8)0x03)
#define LOGUART_PATH_INDEX_5		((u8)0x04)
...
/** @defgroup LOGUART_Rx_Err_Report
  * @{
  */
#define LOGUART_RX_ERROR_REPORT_DISABLE		((u32)0x00000000)
#define LOGUART_RX_ERROR_REPORT_ENABLE		((u32)0x00000001)

#define IS_LOGUART_RX_ERROR_REPORT(REPORT)  (((REPORT) == LOGUART_RX_ERROR_REPORT_DISABLE) || \
											((REPORT) == LOGUART_RX_ERROR_REPORT_ENABLE) )
/**
  * @}
  */
...
#define IS_LOGUART_TX_EMPTY_INTR(PATHINDEX) (((PATHINDEX) == LOGUART_TX_EMPTY_PATH_1_INTR) || \
...
_LONG_CALL_ void LOGUART_INTCoreConfig(LOGUART_TypeDef *UARTLOG, u32 IntCoreMask, u32 NewState);
...
_LONG_CALL_ void LOGUART_WaitTx(void);
_LONG_CALL_ void LOGUART_PutChar(u8 c);
_LONG_CALL_ u8 LOGUART_GetChar(bool PullMode);
_LONG_CALL_ u32 LOGUART_PutStr(char *pstr, u32 Length);
...
_LONG_CALL_ void LOGUART_TXDMAConfig(LOGUART_TypeDef *UARTLOG, u32 TxDmaBurstSize);
_LONG_CALL_ void LOGUART_RXDMAConfig(LOGUART_TypeDef *UARTLOG, u32 RxDmaBurstSize);
_LONG_CALL_ void LOGUART_TXDMACmd(LOGUART_TypeDef *UARTLOG, u32 NewState);
