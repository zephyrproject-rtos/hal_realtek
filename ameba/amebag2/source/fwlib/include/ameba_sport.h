...
/** @defgroup SP_CTRL0
  ...
  * @{
  */
#define SP_MASK_MCLK_SEL             ((u32)0x00000003 << 30)           /*!< R/W 0x0  not used, please refer to 0x64 2'b00: MCLK output=dsp_src_clk/4 2'b01: MCLK output=dsp_src_clk/2 2'b10/2'b11: MCLK output=dsp_src_clk*/
...
#define SP_BIT_START_RX              ((u32)0x00000001 << 25)           /*!< R/W 0x0  1'b0: RX is disabled 1'b1: RX is started*/
#define SP_BIT_RX_DISABLE            ((u32)0x00000001 << 24)           /*!< R/W 0x1  1'b1: SPORT RX is disabled. 1'b0: SPORT RX is enabled.*/
#define SP_BIT_RX_LSB_FIRST_0        ((u32)0x00000001 << 23)           /*!< R/W 0x0  1'b0: MSB first when RX 1'b1: LSB first*/
#define SP_BIT_TX_LSB_FIRST_0        ((u32)0x00000001 << 22)           /*!< R/W 0x0  1'b0: MSB first when TX 1'b1: LSB first*/
...
#define SP_BIT_START_TX              ((u32)0x00000001 << 17)           /*!< R/W 0x0  1'b0: TX is disabled. 1'b1: TX is started.*/
#define SP_BIT_TX_DISABLE            ((u32)0x00000001 << 16)           /*!< R/W 0x1  1'b1: SPORT TX is disabled. 1'b0: SPORT TX is enabled.*/
#define SP_BIT_I2S_SELF_LPBK_EN      ((u32)0x00000001 << 15)           /*!< R/W 0x0  1'b1: internal loopback mode is enabled*/
...
#define SP_BIT_EN_I2S_MONO_TX_0      ((u32)0x00000001 << 11)           /*!< R/W 0x0  1'b1: mono 1'b0: stereo*/
#define SP_BIT_INV_I2S_SCLK          ((u32)0x00000001 << 10)           /*!< R/W 0x0  1'b1: I2S/PCM bit clock is inverted*/
...
#define SP_BIT_DSP_CTL_MODE          ((u32)0x00000001 << 7)            /*!< R/W 0x0  1'b1: DSP and SPORT1 handshaking is enabled. 1'b0: GDMA and SPORT1 handshaking is enabled.*/
#define SP_BIT_LOOPBACK              ((u32)0x00000001 << 6)            /*!< R/W 0x0  1'b1: self loopback mode*/
#define SP_BIT_WCLK_TX_INVERSE       ((u32)0x00000001 << 5)            /*!< R/W 0x0  1'b1: I2S/PCM word clock is inverted for TX (SPK path)*/
#define SP_BIT_SLAVE_DATA_SEL        ((u32)0x00000001 << 4)            /*!< R/W 0x0  1'b1: To be an I2S or PCM slave (data path)*/
#define SP_BIT_SLAVE_CLK_SEL         ((u32)0x00000001 << 3)            /*!< R/W 0x0  1'b1: To be an I2S or PCM slave (CLK path)*/
#define SP_BIT_RX_INV_I2S_SCLK       ((u32)0x00000001 << 2)            /*!< R/W 0x0  1'b1: sclk to RX path (ADC path) is inverted*/
#define SP_BIT_TX_INV_I2S_SCLK       ((u32)0x00000001 << 1)            /*!< R/W 0x0  1'b1: sclk to TX path (DAC path) is inverted*/
#define SP_BIT_RESET                 ((u32)0x00000001 << 0)            /*!< R/W 0x0  1'b1: reset SPORT1 module, and remember to write "1" to reset and then write "0" to release from reset.*/
/** @} */
...
/** @defgroup SP_CTRL1
  ...
  * @{
  */
#define SP_BIT_RX_FIFO_1_REG_1_EN ((u32)0x00000001 << 31)           /*!< R/W 0x0  1'b1: Enable last two channel of RX_FIFO_1. Only enable when "rx_fifo_1_reg_0_en" = 1.*/
#define SP_BIT_RX_FIFO_1_REG_0_EN ((u32)0x00000001 << 30)           /*!< R/W 0x0  1'b1: Enable first two channel of RX_FIFO_1. Only enable when "rx_fifo_0_reg_0_en" = 1.*/
#define SP_BIT_RX_FIFO_0_REG_1_EN ((u32)0x00000001 << 29)           /*!< R/W 0x0  1'b1: Enable last two channel of RX_FIFO_0. Only enable when "rx_fifo_0_reg_0_en" = 1.*/
#define SP_BIT_RX_FIFO_0_REG_0_EN ((u32)0x00000001 << 28)           /*!< R/W 0x1  1'b1: Enable first two channel of RX_FIFO_0. Disable 0x0008[28] ~ Disable 0x0008[31] at the same time to reset RX FIFO.*/
#define SP_BIT_TX_FIFO_1_REG_1_EN ((u32)0x00000001 << 27)           /*!< R/W 0x0  1'b1: Enable last two channel of TX_FIFO_1. Only enable when "tx_fifo_1_reg_0_en" = 1.*/
#define SP_BIT_TX_FIFO_1_REG_0_EN ((u32)0x00000001 << 26)           /*!< R/W 0x0  1'b1: Enable first two channel of TX_FIFO_1. Only enable when "tx_fifo_0_reg_0_en" = 1.*/
#define SP_BIT_TX_FIFO_0_REG_1_EN ((u32)0x00000001 << 25)           /*!< R/W 0x0  1'b1: Enable last two channel of TX_FIFO_0. Only enable when "tx_fifo_0_reg_0_en" = 1.*/
#define SP_BIT_TX_FIFO_0_REG_0_EN ((u32)0x00000001 << 24)           /*!< R/W 0x1  1'b1: Enable first two channel of TX_FIFO_0. Disable 0x0008[24] ~ Disable 0x0008[27] at the same time to reset TX FIFO.*/
#define SP_BIT_RX_SNK_LR_SWAP_0   ((u32)0x00000001 << 23)           /*!< R/W 0x0  1'b1: swap L/R audio samples written to the sink memory of RX_FIFO_0;*/
#define SP_BIT_RX_SNK_BYTE_SWAP_0 ((u32)0x00000001 << 22)           /*!< R/W 0x0  1'b1: swap H/L bytes written to the sink memory of RX_FIFO_0;*/
#define SP_BIT_TX_SRC_LR_SWAP_0   ((u32)0x00000001 << 21)           /*!< R/W 0x0  1'b1: swap L/R audio samples read from the source memory of TX_FIFO_0;*/
#define SP_BIT_TX_SRC_BYTE_SWAP_0 ((u32)0x00000001 << 20)           /*!< R/W 0x0  1'b1: swap H/L bytes read from the source memory of TX_FIFO_0;*/
#define SP_BIT_DIRECT_MODE_EN     ((u32)0x00000001 << 19)           /*!< R/W 0x0  1'b1: WS(LRCK)  and SCK(BCLK) are from other sport*/
...
#define SP_BIT_ERR_CNT_SAT_SET    ((u32)0x00000001 << 16)           /*!< R/W 0x0  1'b1: saturation count (65534 --> 65535 --> 65535 ...) 1'b0: wrap count (65534 --> 65535 --> 0 --> 1 --> 2 ...)*/
...
#define SP_BIT_CLEAR_RX_ERR_CNT   ((u32)0x00000001 << 13)           /*!< R/W 0x0  Write 1'b1 and then write 0 to clear RX error counter*/
#define SP_BIT_CLEAR_TX_ERR_CNT   ((u32)0x00000001 << 12)           /*!< R/W 0x0  Write 1'b1 and then write 0 to clear TX error counter*/
#define SP_BIT_ENABLE_MCLK        ((u32)0x00000001 << 11)           /*!< R/W 0x0  Enable mclk.*/
...
#define SP_BIT_WS_FORCE_VAL       ((u32)0x00000001 << 7)            /*!< R/W 0x1  When "ws_force" = 1, ws_out_tx and ws_out_rx = "ws_force_val."*/
#define SP_BIT_WS_FORCE           ((u32)0x00000001 << 6)            /*!< R/W 0x0  1'b1: Make ws_out_tx and ws_out_rx = "ws_force_val."*/
#define SP_BIT_BCLK_RESET         ((u32)0x00000001 << 5)            /*!< R/W 0x0  1'b0: Enable bclk 1'b1: Disable and reset bclk*/
#define SP_BIT_BCLK_PULL_ZERO     ((u32)0x00000001 << 4)            /*!< R/W 0x0  Write 1'b1 to pull bclk to 0 smoothly. Write 1'b0 to reopen bclk.*/
#define SP_BIT_MULTI_IO_EN_RX     ((u32)0x00000001 << 3)            /*!< R/W 0x1  1'b1: Enable multi-IO of rx 1'b0: Disable multi-IO of rx*/
#define SP_BIT_MULTI_IO_EN_TX     ((u32)0x00000001 << 2)            /*!< R/W 0x1  1'b1: Enable multi-IO of tx 1'b0: Disable multi-IO of tx*/
#define SP_BIT_TX_FIFO_FILL_ZERO  ((u32)0x00000001 << 1)            /*!< WA0 0x0  X is the burst size of TX_FIFO_0. Y is the burst size of TX_FIFO_1.  Fill TX_FIFO_0 with X zero data and fill TX_FIFO_1 with Y zero data.  This control bit is "write 1 clear" type*/
#define SP_BIT_RESET_SMOOTH       ((u32)0x00000001 << 0)            /*!< R/W 0x0  1'b1: reset SPORT1 module with complete LRCK cycle.*/
/** @} */
...
#define SP_BIT_LRC_STOP_INTR       ((u32)0x00000001 << 15)           /*!< R/WA0 0x0  */
#define SP_BIT_LRC_START_INTR      ((u32)0x00000001 << 14)           /*!< R/WA0 0x0  */
...
#define SP_BIT_RX_DSP_CLEAR_INT_1  ((u32)0x00000001 << 8)            /*!< R/W 0x0  For DSP mode (bypass GDMA), F/W writes 1'b1 and then 1'b0 to clear RX interrupt. Note: RX interrupt is to indicate that DSP can get audio data from RX FIFO_1*/
#define SP_BIT_TX_DSP_CLEAR_INT_1  ((u32)0x00000001 << 7)            /*!< R/W 0x0  For DSP mode (bypass GDMA), F/W writes 1'b1 and then 1'b0 to clear TX interrupt. Note: TX interrupt is to indicate that DSP can write audio data to TX FIFO_1*/
...
#define SP_BIT_RX_DSP_CLEAR_INT_0  ((u32)0x00000001 << 1)            /*!< R/W 0x0  For DSP mode (bypass GDMA), F/W writes 1'b1 and then 1'b0 to clear RX interrupt. Note: RX interrupt is to indicate that DSP can get audio data from RX FIFO_0*/
#define SP_BIT_TX_DSP_CLEAR_INT_0  ((u32)0x00000001 << 0)            /*!< R/W 0x0  For DSP mode (bypass GDMA), F/W writes 1'b1 and then 1'b0 to clear TX interrupt. Note: TX interrupt is to indicate that DSP can write audio data to TX FIFO_0*/
/** @} */
...
/** @defgroup SP_TRX_COUNTER_STATUS
  ...
  * @{
  */
#define SP_BIT_RESET_STATE       ((u32)0x00000001 << 31)           /*!< R 0x0  1'b1: sp_reset is enable 1'b0: sp_reset is disable*/
...
/** @defgroup SP_SR_TX_BCLK
  ...
  * @{
  */
#define SP_BIT_TX_MI_NI_UPDATE ((u32)0x00000001 << 31)           /*!< R/W 0x0  1'b1: to update "mi" and "ni" to get the new clock rate. This bit will be reset automatically when the update is done*/
...
#define SP_BIT_WIFI_TRIG_AUDIO_EN   ((u32)0x00000001 << 15)           /*!< R/W 0x0  enable wifi trigger to start audio stream*/
#define SP_BIT_DUMMY1               ((u32)0x00000001 << 14)           /*!< R/W 0x0  -*/
...
#define SP_MASK_DUMMY2              ((u32)0x00000003 << 6)            /*!< R/W 0x0  -*/
#define SP_DUMMY2(x)                (((u32)((x) & 0x00000003) << 6))
#define SP_GET_DUMMY2(x)            ((u32)(((x >> 6) & 0x00000003)))
...
/** @defgroup SP_FIFO_CTRL
  ...
  * @{
  */
#define SP_BIT_RX_FIFO_EMPTY_0      ((u32)0x00000001 << 31) /*!< R 0x1  1: RX FIFO_0 is empty*/
#define SP_BIT_TX_FIFO_EMPTY_0      ((u32)0x00000001 << 30) /*!< R 0x1  1: TX FIFO_0 is empty*/
#define SP_BIT_RX_FIFO_FULL_0       ((u32)0x00000001 << 29) /*!< R 0x0  1: RX FIFO_0 is full*/
#define SP_BIT_TX_FIFO_FULL_0       ((u32)0x00000001 << 28) /*!< R 0x0  1: TX FIFO_0 is full*/
#define SP_BIT_RX_FIFO_EMPTY_1      ((u32)0x00000001 << 27) /*!< R 0x1  1: RX FIFO_1 is empty*/
#define SP_BIT_TX_FIFO_EMPTY_1      ((u32)0x00000001 << 26) /*!< R 0x1  1: TX FIFO_1 is empty*/
#define SP_BIT_RX_FIFO_FULL_1       ((u32)0x00000001 << 25) /*!< R 0x0  1: RX FIFO_1 is full*/
#define SP_BIT_TX_FIFO_FULL_1       ((u32)0x00000001 << 24) /*!< R 0x0  1: TX FIFO_1 is full*/
#define SP_BIT_TX_I2S_IDLE_1        ((u32)0x00000001 << 13) /*!< R 0x0  1: TX is working but FIFO_1 is empty.*/
#define SP_BIT_RX_FIFO_EMPTY_INTR_1 ((u32)0x00000001 << 12) /*!< R 0x0  1: RX FIFO_1 is empty (MIC path)*/
#define SP_BIT_TX_FIFO_EMPTY_INTR_1 ((u32)0x00000001 << 11) /*!< R 0x0  1: TX FIFO_1 is empty (SPK path)*/
#define SP_BIT_RX_FIFO_FULL_INTR_1  ((u32)0x00000001 << 10) /*!< R 0x0  1: RX FIFO_1 is full (MIC path)*/
#define SP_BIT_TX_FIFO_FULL_INTR_1  ((u32)0x00000001 << 9)  /*!< R 0x0  1: TX FIFO_1 is full (SPK path)*/
#define SP_BIT_READY_TO_RX_1        ((u32)0x00000001 << 8)  /*!< R 0x0  1: It is ready to receive data (MIC path)*/
#define SP_BIT_READY_TO_TX_1        ((u32)0x00000001 << 7)  /*!< R 0x0  1: It is ready to send data out (SPK path)*/
#define SP_BIT_TX_I2S_IDLE_0        ((u32)0x00000001 << 6)  /*!< R 0x0  1: TX is working but FIFO_0 is empty.*/
#define SP_BIT_RX_FIFO_EMPTY_INTR_0 ((u32)0x00000001 << 5)  /*!< R 0x0  1: RX FIFO_0 is empty (MIC path)*/
#define SP_BIT_TX_FIFO_EMPTY_INTR_0 ((u32)0x00000001 << 4)  /*!< R 0x0  1: TX FIFO_0 is empty (SPK path)*/
#define SP_BIT_RX_FIFO_FULL_INTR_0  ((u32)0x00000001 << 3)  /*!< R 0x0  1: RX FIFO_0 is full (MIC path)*/
#define SP_BIT_TX_FIFO_FULL_INTR_0  ((u32)0x00000001 << 2)  /*!< R 0x0  1: TX FIFO_0 is full (SPK path)*/
#define SP_BIT_READY_TO_RX_0        ((u32)0x00000001 << 1)  /*!< R 0x0  1: It is ready to receive data (MIC path)*/
#define SP_BIT_READY_TO_TX_0        ((u32)0x00000001 << 0)  /*!< R 0x0  1: It is ready to send data out (SPK path)*/
/** @} */
...
/** @defgroup SP_FORMAT
  ...
  * @{
  */
#define SP_BIT_TRX_SAME_CH_LEN       ((u32)0x00000001 << 31)           /*!< R/W 0x0  1: TX (SPK path) and RX (MIC path) have the same channel length.*/
#define SP_MASK_CH_LEN_SEL_RX        ((u32)0x00000007 << 28)           /*!< R/W 0x4  3'b000: 16 bits 3'b001: 20 bits 3'b010: 24 bits 3'b011: 8 bits 3'b100: 32 bits*/
#define SP_CH_LEN_SEL_RX(x)          (((u32)((x) & 0x00000007) << 28))
#define SP_GET_CH_LEN_SEL_RX(x)      ((u32)(((x >> 28) & 0x00000007)))
#define SP_BIT_DUMMY3                ((u32)0x00000001 << 27)           /*!< R/W 0x0  -*/
#define SP_MASK_CH_LEN_SEL_TX        ((u32)0x00000007 << 24)           /*!< R/W 0x4  3'b000: 16 bits 3'b001: 20 bits 3'b010: 24 bits 3'b011: 8 bits 3'b100: 32 bits*/
#define SP_CH_LEN_SEL_TX(x)          (((u32)((x) & 0x00000007) << 24))
#define SP_GET_CH_LEN_SEL_TX(x)      ((u32)(((x >> 24) & 0x00000007)))
#define SP_BIT_RX_IDEAL_LEN_EN       ((u32)0x00000001 << 23)           /*!< R/W 0x0  Function enable of rx_ideal_len.*/
...
#define SP_BIT_TX_IDEAL_LEN_EN       ((u32)0x00000001 << 19)           /*!< R/W 0x0  Function enable of tx_ideal_len. PCMA SDO will be delayed 1 LRCK.*/
...
#define SP_BIT_DUMMY4                ((u32)0x00000001 << 15)           /*!< R/W 0x0  -*/
#define SP_MASK_DATA_LEN_SEL_RX_0    ((u32)0x00000007 << 12)           /*!< R/W 0x0  Data length of MIC path and it is valid if "trx_same_length" == 1'b0. 3'b000: 16 bits 3'b001: 20 bits 3'b010: 24 bits 3'b011: 8 bits 3'b100: 32 bits*/
#define SP_DATA_LEN_SEL_RX_0(x)      (((u32)((x) & 0x00000007) << 12))
#define SP_GET_DATA_LEN_SEL_RX_0(x)  ((u32)(((x >> 12) & 0x00000007)))
#define SP_BIT_EN_I2S_MONO_RX_0      ((u32)0x00000001 << 11)           /*!< R/W 0x0  Channel format of MIC path and it is valid if  "trx_same_ch" == 1'b0. 1: mono 0: stereo*/
#define SP_BIT_TRX_SAME_LRC          ((u32)0x00000001 << 10)           /*!< R/W 0x0  1:  "ws_out_rx" is as same as "ws_out_tx"*/
...
#define SP_BIT_FIXED_BCLK            ((u32)0x00000001 << 7)            /*!< R/W 0x0  1: Refer to the description of "fixed_bclk_sel" 0: BCLK = dsp_clk/2 when "mode_40mhz = 0"*/
#define SP_BIT_FIXED_BCLK_SEL        ((u32)0x00000001 << 6)            /*!< R/W 0x0  0: BCLK is fixed at dsp_src_clk/4 1: BCLK is fixed at dsp_src_clk/2*/
#define SP_BIT_WCLK_RX_INVERSE       ((u32)0x00000001 << 5)            /*!< R/W 0x0  1:  invert the phase of "ws_out_rx" which is also called as "ADCLRC"*/
#define SP_BIT_DUMMY5                ((u32)0x00000001 << 4)            /*!< R/W 0x0  -*/
#define SP_BIT_SCK_OUT_INVERSE       ((u32)0x00000001 << 3)            /*!< R/W 0x0  1: invert the phase of "sck_out"*/
#define SP_BIT_TRX_SAME_LENGTH       ((u32)0x00000001 << 2)            /*!< R/W 0x1  1: TX (SPK path) and RX (MIC path) have the same data length.       Both are either 16 or 24 bits*/
#define SP_BIT_TRX_SAME_CH           ((u32)0x00000001 << 1)            /*!< R/W 0x1  1: TX (SPK path) and RX (MIC path) have the same channel setting.       Both are either stereo or mono*/
#define SP_BIT_TRX_SAME_FS           ((u32)0x00000001 << 0)            /*!< R/W 0x1  1: TX (SPK path) and RX (MIC path) have the same sampling rate*/
/** @} */
...
/** @defgroup SP_RX_BCLK
  ...
  * @{
  */
#define SP_BIT_RX_MI_NI_UPDATE ((u32)0x00000001 << 31)           /*!< R/W 0x0  1'b1: to update "mi" and "ni" to get the new clock rate. This bit will be reset automatically when the update is done*/
...
/** @defgroup SP_RX_LRCLK
  ...
  * @{
  */
#define SP_BIT_CLR_TX_SPORT_RDY        ((u32)0x00000001 << 31)          /*!< WA0 0x0  0x001: clear tx_sport_interrupt signal This control bit is "write 1 clear" type  For read, the read data is from clr_tx_sport_rdy*/
#define SP_BIT_EN_TX_SPORT_INTERRUPT   ((u32)0x00000001 << 30)          /*!< R/W 0x0  Enable tx_sport_interrupt*/
#define SP_BIT_EN_FS_PHASE_LATCH       ((u32)0x00000001 << 29)          /*!< WA0 0x0  0x001: Latch the value of tx_fs_phase_rpt, rx_fs_phase_rpt, tx_sport_sounter, rx_sport_sounter at the same time. This control bit is "write 1 clear" type*/
#define SP_BIT_EN_TSFT_TRIG_LATCH      ((u32)0x00000001 << 28)          /*!< R/W 0x0  Enable wifi tsft trigger fs_phase_latch*/
#define SP_BIT_TX_FS_PHASE_RPT_B5      ((u32)0x00000001 << 27)          /*!< R 0x0  tx_fs_phase_rptp[5] when using div64 fs_phase_trace_cnt*/
...
/** @defgroup SP_FIFO_IRQ
  ...
  * @{
  */
#define SP_BIT_RX_LSB_FIRST_1      ((u32)0x00000001 << 31)           /*!< R/W 0x0  1'b0: MSB first when TX 1'b1: LSB first*/
#define SP_BIT_TX_LSB_FIRST_1      ((u32)0x00000001 << 30)           /*!< R/W 0x0  1'b0: MSB first when TX 1'b1: LSB first*/
#define SP_BIT_RX_SNK_LR_SWAP_1    ((u32)0x00000001 << 29)           /*!< R/W 0x0  1'b1: swap L/R audio samples written to the sink memory of RX_FIFO_1*/
#define SP_BIT_RX_SNK_BYTE_SWAP_1  ((u32)0x00000001 << 28)           /*!< R/W 0x0  1'b1: swap H/L bytes written to the sink memory of RX_FIFO_1*/
#define SP_BIT_TX_SRC_LR_SWAP_1    ((u32)0x00000001 << 27)           /*!< R/W 0x0  1'b1: swap L/R audio samples read from the source memory of TX_FIFO_1*/
#define SP_BIT_TX_SRC_BYTE_SWAP_1  ((u32)0x00000001 << 26)           /*!< R/W 0x0  1'b1: swap H/L bytes read from the source memory of TX_FIFO_1*/
#define SP_MASK_DUMMY7             ((u32)0x000003FF << 16)           /*!< R/W 0x0  -*/
#define SP_DUMMY7(x)               (((u32)((x) & 0x000003FF) << 16))
#define SP_GET_DUMMY7(x)           ((u32)(((x >> 16) & 0x000003FF)))
#define SP_MASK_INT_ENABLE_MCU_1   ((u32)0x000000FF << 8)            /*!< R/W 0x0  Bit[8]: for the interrupt of "sp_ready_to_tx" Bit[9]: for the interrupt of "sp_ready_to_rx" Bit[10]: for the interrupt of "tx_fifo_full_intr" Bit[11]: for the interrupt of "rx_fifo_full_intr" Bit[12]: for the interrupt of "tx_fifo_empty_intr" Bit[13]: for the interrupt of "rx_fifo_empty_intr" Bit[14]: for the interrupt of "tx_i2s_idle" Bit[15]: Reserved*/
#define SP_INT_ENABLE_MCU_1(x)     (((u32)((x) & 0x000000FF) << 8))
#define SP_GET_INT_ENABLE_MCU_1(x) ((u32)(((x >> 8) & 0x000000FF)))
#define SP_MASK_INT_ENABLE_MCU_0   ((u32)0x000000FF << 0)            /*!< R/W 0x0  Bit[0]: for the interrupt of "sp_ready_to_tx" Bit[1]: for the interrupt of "sp_ready_to_rx" Bit[2]: for the interrupt of "tx_fifo_full_intr" Bit[3]: for the interrupt of "rx_fifo_full_intr" Bit[4]: for the interrupt of "tx_fifo_empty_intr" Bit[5]: for the interrupt of "rx_fifo_empty_intr" Bit[6]: for the interrupt of "tx_i2s_idle" Bit[7]: Reserved*/
...
/** @defgroup SP_DIRECT_CTRL1
  ...
  * @{
  */
#define SP_BIT_EN_I2S_MONO_RX_1     ((u32)0x00000001 << 31)           /*!< R/W 0x0  Channel format of MIC path and it is valid if  "trx_same_ch" == 1'b0. 1'b1: mono 1'b0: stereo*/
#define SP_MASK_DATA_LEN_SEL_RX_1   ((u32)0x00000007 << 28)           /*!< R/W 0x0  Data length of MIC path and it is valid if "trx_same_length" == 1'b0. 3'b000: 16 bits 3'b001: 20 bits 3'b010: 24 bits 3'b011: 8 bits 3'b100: 32 bits*/
#define SP_DATA_LEN_SEL_RX_1(x)     (((u32)((x) & 0x00000007) << 28))
#define SP_GET_DATA_LEN_SEL_RX_1(x) ((u32)(((x >> 28) & 0x00000007)))
#define SP_BIT_EN_I2S_MONO_TX_1     ((u32)0x00000001 << 27)           /*!< R/W 0x0  1'b1: mono 1'b0: stereo*/
#define SP_MASK_DATA_LEN_SEL_TX_1   ((u32)0x00000007 << 24)           /*!< R/W 0x0  3'b000: 16 bits 3'b001: 20 bits 3'b010: 24 bits 3'b011: 8 bits 3'b100: 32 bits*/
#define SP_DATA_LEN_SEL_TX_1(x)     (((u32)((x) & 0x00000007) << 24))
#define SP_GET_DATA_LEN_SEL_TX_1(x) ((u32)(((x >> 24) & 0x00000007)))
#define SP_BIT_DIRECT_REG_3_EN      ((u32)0x00000001 << 23)           /*!< R/W 0x0  1'b1: Enable direct_reg_3.*/
...
#define SP_BIT_DIRECT_REG_2_EN      ((u32)0x00000001 << 17)           /*!< R/W 0x0  1'b1: Enable direct_reg_2.*/
...
#define SP_BIT_DIRECT_REG_1_EN      ((u32)0x00000001 << 11)           /*!< R/W 0x0  1'b1: Enable direct_reg_1.*/
...
#define SP_BIT_DIRECT_REG_0_EN      ((u32)0x00000001 << 5)            /*!< R/W 0x0  1'b1: Enable direct_reg_0.*/
...
/** @defgroup SP_DIRECT_CTRL2
  ...
  * @{
  */
#define SP_BIT_DIRECT_OUT_7_EN     ((u32)0x00000001 << 31)           /*!< R/W 0x0  Enable sp_direct_out_7.*/
#define SP_BIT_DIRECT_OUT_6_EN     ((u32)0x00000001 << 30)           /*!< R/W 0x0  Enable sp_direct_out_6.*/
#define SP_BIT_DIRECT_OUT_5_EN     ((u32)0x00000001 << 29)           /*!< R/W 0x0  Enable sp_direct_out_5.*/
#define SP_BIT_DIRECT_OUT_4_EN     ((u32)0x00000001 << 28)           /*!< R/W 0x0  Enable sp_direct_out_4.*/
#define SP_BIT_DIRECT_OUT_3_EN     ((u32)0x00000001 << 27)           /*!< R/W 0x0  Enable sp_direct_out_3.*/
#define SP_BIT_DIRECT_OUT_2_EN     ((u32)0x00000001 << 26)           /*!< R/W 0x0  Enable sp_direct_out_2.*/
#define SP_BIT_DIRECT_OUT_1_EN     ((u32)0x00000001 << 25)           /*!< R/W 0x0  Enable sp_direct_out_1.*/
#define SP_BIT_DIRECT_OUT_0_EN     ((u32)0x00000001 << 24)           /*!< R/W 0x0  Enable sp_direct_out_0.*/
#define SP_BIT_DIRECT_REG_7_EN     ((u32)0x00000001 << 23)           /*!< R/W 0x0  1'b1: Enable direct_reg_7.*/
...
#define SP_BIT_DIRECT_REG_6_EN     ((u32)0x00000001 << 17)           /*!< R/W 0x0  1'b1: Enable direct_reg_6.*/
...
#define SP_BIT_DIRECT_REG_5_EN     ((u32)0x00000001 << 11)           /*!< R/W 0x0  1'b1: Enable direct_reg_5.*/
...
#define SP_BIT_DIRECT_REG_4_EN     ((u32)0x00000001 << 5)            /*!< R/W 0x0  1'b1: Enable direct_reg_4.*/
...
/** @defgroup SP_DIRECT_CTRL3
  ...
  * @{
  */
#define SP_MASK_DUMMY8                  ((u32)0x00000007 << 29)           /*!< R/W 0x0  -*/
#define SP_DUMMY8(x)                    (((u32)((x) & 0x00000007) << 29))
#define SP_GET_DUMMY8(x)                ((u32)(((x >> 29) & 0x00000007)))
...
#define SP_MASK_DUMMY9                  ((u32)0x00000007 << 21)           /*!< R/W 0x0  */
#define SP_DUMMY9(x)                    (((u32)((x) & 0x00000007) << 21))
#define SP_GET_DUMMY9(x)                ((u32)(((x >> 21) & 0x00000007)))
...
#define SP_MASK_DUMMY10                 ((u32)0x00000007 << 13)           /*!< R/W 0x0  */
#define SP_DUMMY10(x)                   (((u32)((x) & 0x00000007) << 13))
#define SP_GET_DUMMY10(x)               ((u32)(((x >> 13) & 0x00000007)))
...
#define SP_MASK_DUMMY11                 ((u32)0x00000007 << 5)            /*!< R/W 0x0  */
#define SP_DUMMY11(x)                   (((u32)((x) & 0x00000007) << 5))
#define SP_GET_DUMMY11(x)               ((u32)(((x >> 5) & 0x00000007)))
...
/** @defgroup SP_DIRECT_CTRL4
  ...
  * @{
  */
#define SP_MASK_DUMMY12                 ((u32)0x00000007 << 29)           /*!< R/W 0x0  */
#define SP_DUMMY12(x)                   (((u32)((x) & 0x00000007) << 29))
#define SP_GET_DUMMY12(x)               ((u32)(((x >> 29) & 0x00000007)))
...
#define SP_MASK_DUMMY13                 ((u32)0x00000007 << 21)           /*!< R/W 0x0  */
#define SP_DUMMY13(x)                   (((u32)((x) & 0x00000007) << 21))
#define SP_GET_DUMMY13(x)               ((u32)(((x >> 21) & 0x00000007)))
...
#define SP_MASK_DUMMY14                 ((u32)0x00000007 << 13)           /*!< R/W 0x0  */
#define SP_DUMMY14(x)                   (((u32)((x) & 0x00000007) << 13))
#define SP_GET_DUMMY14(x)               ((u32)(((x >> 13) & 0x00000007)))
...
#define SP_MASK_DUMMY15                 ((u32)0x00000007 << 5)            /*!< R/W 0x0  */
#define SP_DUMMY15(x)                   (((u32)((x) & 0x00000007) << 5))
#define SP_GET_DUMMY15(x)               ((u32)(((x >> 5) & 0x00000007)))
...
/** @defgroup SP_RX_COUNTER1
  ...
  * @{
  */
#define SP_BIT_CLR_RX_SPORT_RDY        ((u32)0x00000001 << 31)          /*!< WA0 0x0  X = (tx_sport_compare_val). When counter equal X. Sport will send tx_sport_interrupt to DSP.  FW should take care X={32~8191}*/
#define SP_BIT_EN_RX_SPORT_INTERRUPT   ((u32)0x00000001 << 30)          /*!< R/W 0x0  Enable rx sport interrupt.*/
#define SP_BIT_DUMMY16                 ((u32)0x00000001 << 29)          /*!< R/W 0x0  */
#define SP_BIT_FS_PHASE_EN_D64         ((u32)0x00000001 << 28)          /*!< R/W 0x0  Enable div64 fs_phase_trace_cnt for both tx  and rx*/
#define SP_BIT_RX_FS_PHASE_RPT_B5      ((u32)0x00000001 << 27)          /*!< R 0x0  rx_fs_phase_rptp[5] when using div64 fs_phase_trace_cnt*/
...
/** @defgroup SP_MCLK
  ...
  * @{
  */
#define SP_BIT_MCLK_MI_NI_UPDATE ((u32)0x00000001 << 31)           /*!< R/W 0x0  1'b1: to update "mi" and "ni" to get the new clock rate. This bit will be reset automatically when the update is done*/
#define SP_MASK_MCLK_NI          ((u32)0x00007FFF << 16)           /*!< R/W 0xc0  mclk_out = 40MHz*(ni/mi)      For example: mclk_out=3.072MHz=40MHz*(48/625)*/
#define SP_MCLK_NI(x)            (((u32)((x) & 0x00007FFF) << 16))
#define SP_GET_MCLK_NI(x)        ((u32)(((x >> 16) & 0x00007FFF)))
#define SP_MASK_MCLK_MI          ((u32)0x0000FFFF << 0)            /*!< R/W 0x271  */
#define SP_MCLK_MI(x)            (((u32)((x) & 0x0000FFFF) << 0))
#define SP_GET_MCLK_MI(x)        ((u32)(((x >> 0) & 0x0000FFFF)))
/** @} */

/** @defgroup SP_TX_EX_PHASE_RPT
  * @brief
  * @{
  */
#define SP_MASK_TX_EX_PHASE_RPT   ((u32)0x0000FFFF << 0)           /*!< R 0x0  Report TX phase, counted by sport_clk*/
#define SP_TX_EX_PHASE_RPT(x)     (((u32)((x) & 0x0000FFFF) << 0))
#define SP_GET_TX_EX_PHASE_RPT(x) ((u32)(((x >> 0) & 0x0000FFFF)))
/** @} */

/** @defgroup SP_RX_EX_PHASE_RPT
  * @brief
  * @{
  */
#define SP_MASK_RX_EX_PHASE_RPT   ((u32)0x0000FFFF << 0)           /*!< R 0x0  Report RX phase, counted by sport_clk*/
#define SP_RX_EX_PHASE_RPT(x)     (((u32)((x) & 0x0000FFFF) << 0))
#define SP_GET_RX_EX_PHASE_RPT(x) ((u32)(((x >> 0) & 0x0000FFFF)))
/** @} */
...
/** @defgroup SP_CTRL2
  ...
  * @{
  */
#define SP_BIT_LRC_START_POL       ((u32)0x00000001 << 26)          /*!< R/W 0x0  1: lrclk rising edge as lrc start 0: lrclk falling edge as lrc start*/
#define SP_BIT_RX_DMA_SINGLE_LOW   ((u32)0x00000001 << 25)          /*!< R/W 0x0  disable rx_dma_single*/
#define SP_BIT_TX_DMA_SINGLE_LOW   ((u32)0x00000001 << 24)          /*!< R/W 0x0  disable tx_dma_single*/
#define SP_BIT_LRC_STOP_INTR_MASK  ((u32)0x00000001 << 18)          /*!< R/W 0x0  */
#define SP_BIT_LRC_START_INTR_MASK ((u32)0x00000001 << 17)          /*!< R/W 0x0  */
#define SP_BIT_EX_PHASE_CNT_EN     ((u32)0x00000001 << 16)          /*!< R/W 0x0  enable t/rx exact phase counter, counted by sport_clk*/
#define SP_MASK_LRC_STOP_THRESH    ((u32)0x0000FFFF << 0)           /*!< R/W 0x0  either tx or rx excat phase counter > this value, generate lrc_stop_intr*/
#define SP_LRC_STOP_THRESH(x)      (((u32)((x) & 0x0000FFFF) << 0))
#define SP_GET_LRC_STOP_THRESH(x)  ((u32)(((x >> 0) & 0x0000FFFF)))
/** @} */
...
typedef struct {
	__IO uint32_t SP_REG_MUX           ;  /*!< Register,  Address offset:0x000 */
	__IO uint32_t SP_CTRL0             ;  /*!< Register,  Address offset:0x004 */
	__IO uint32_t SP_CTRL1             ;  /*!< Register,  Address offset:0x008 */
	__IO uint32_t SP_INT_CTRL          ;  /*!< Register,  Address offset:0x00C */
	__IO uint32_t RSVD0                ;  /*!< Reserved,  Address offset:0x010-0x013 */
	__I  uint32_t SP_TRX_COUNTER_STATUS;  /*!< Register,  Address offset:0x014 */
	__I  uint32_t SP_ERR               ;  /*!< Register,  Address offset:0x018 */
	__IO uint32_t SP_SR_TX_BCLK        ;  /*!< Register,  Address offset:0x01C */
	__IO uint32_t SP_TX_LRCLK          ;  /*!< Register,  Address offset:0x020 */
	__I  uint32_t SP_FIFO_CTRL         ;  /*!< Register,  Address offset:0x024 */
	__IO uint32_t SP_FORMAT            ;  /*!< Register,  Address offset:0x028 */
	__IO uint32_t SP_RX_BCLK           ;  /*!< Register,  Address offset:0x02C */
	__IO uint32_t SP_RX_LRCLK          ;  /*!< Register,  Address offset:0x030 */
	__I  uint32_t SP_DSP_COUNTER       ;  /*!< Register,  Address offset:0x034 */
	__IO uint32_t RSVD1                ;  /*!< Reserved,  Address offset:0x038-0x03B */
	__IO uint32_t SP_DIRECT_CTRL0      ;  /*!< Register,  Address offset:0x03C */
	__IO uint32_t RSVD2                ;  /*!< Reserved,  Address offset:0x040-0x043 */
	__IO uint32_t SP_FIFO_IRQ          ;  /*!< Register,  Address offset:0x044 */
	__IO uint32_t SP_DIRECT_CTRL1      ;  /*!< Register,  Address offset:0x048 */
	__IO uint32_t SP_DIRECT_CTRL2      ;  /*!< Register,  Address offset:0x04C */
	__IO uint32_t RSVD3                ;  /*!< Reserved,  Address offset:0x050-0x053 */
	__IO uint32_t SP_DIRECT_CTRL3      ;  /*!< Register,  Address offset:0x054 */
	__IO uint32_t SP_DIRECT_CTRL4      ;  /*!< Register,  Address offset:0x058 */
	__IO uint32_t SP_RX_COUNTER1       ;  /*!< Register,  Address offset:0x05C */
	__I  uint32_t SP_RX_COUNTER2       ;  /*!< Register,  Address offset:0x060 */
	__IO uint32_t SP_MCLK              ;  /*!< Register,  Address offset:0x064 */
	__I  uint32_t SP_TX_EX_PHASE_RPT   ;  /*!< Register,  Address offset:0x068 */
	__I  uint32_t SP_RX_EX_PHASE_RPT   ;  /*!< Register,  Address offset:0x06C */
	__IO uint32_t SP_CTRL2             ;  /*!< Register,  Address offset:0x070 */
	__IO uint32_t RSVD4[483]           ;  /*!< Reserved,  Address offset:0x074-0x7FF */
	__O  uint32_t SP_TX_FIFO_0_WR_ADDR ;  /*!< Register,  Address offset:0x800 */
	__IO uint32_t RSVD5[31]            ;  /*!< Reserved,  Address offset:0x804-0x87F */
	__I  uint32_t SP_RX_FIFO_0_RD_ADDR ;  /*!< Register,  Address offset:0x880 */
	__IO uint32_t RSVD6[31]            ;  /*!< Reserved,  Address offset:0x884-0x8FF */
	__O  uint32_t SP_TX_FIFO_1_WR_ADDR ;  /*!< Register,  Address offset:0x900 */
	__IO uint32_t RSVD7[31]            ;  /*!< Reserved,  Address offset:0x904-0x97F */
	__I  uint32_t SP_RX_FIFO_1_RD_ADDR ;  /*!< Register,  Address offset:0x980 */
} AUDIO_SPORT_TypeDef;
...
typedef struct {
	...
	u32 SP_SelClk;		   /*AUDIO SPORT clock sources, 40M/CPUPLL/DSPPLLHz*/
...
_LONG_CALL_ void AUDIO_SP_SetPinMux(u32 i2s_sel, u32 pinfunc_sel);
...
_LONG_CALL_ bool AUDIO_SP_LLPRXGDMA_Init(u32 Index,	u32 SelGDMA, GDMA_InitTypeDef *GDMA_InitStruct, void *CallbackData,
		IRQ_FUN CallbackFunc, u32 Length, u32 MaxLLP, struct GDMA_CH_LLI *Lli);
_LONG_CALL_ void AUDIO_SP_SetPhaseCounterDiv64(u32 index, u32 state);
_LONG_CALL_ void AUDIO_SP_SetExactPhaseCounter(u32 index, u32 state);
_LONG_CALL_ void AUDIO_SP_SetWIFITSFTTrig(u32 index, u32 state);
...
_LONG_CALL_ void AUDIO_SP_SetWIFITSFTTrigLatch(u32 index, u32 state);
_LONG_CALL_ u32 AUDIO_SP_GetTXCounterVal(u32 index);
_LONG_CALL_ u32 AUDIO_SP_GetTXPhaseVal(u32 index);
_LONG_CALL_ u32 AUDIO_SP_GetTXExactPhaseVal(u32 index);
...
_LONG_CALL_ u32 AUDIO_SP_GetRXExactPhaseVal(u32 index);
_LONG_CALL_ void AUDIO_SP_SetLRCLKStartEdge(u32 index, u32 state);
_LONG_CALL_ void AUDIO_SP_SetLRCLKStartIrq(u32 index, u32 state);
_LONG_CALL_ void AUDIO_SP_ClearLRCLKStartIrq(u32 index);
_LONG_CALL_ void AUDIO_SP_SetLRCLKStopIrq(u32 index, u32 state);
_LONG_CALL_ void AUDIO_SP_ClearLRCLKStopIrq(u32 index);
_LONG_CALL_ void AUDIO_SP_SetLRCLKStopThreshold(u32 index, u32 threshold);
_LONG_CALL_ u32 AUDIO_SP_GetLRCLKStopThreshold(u32 index);
